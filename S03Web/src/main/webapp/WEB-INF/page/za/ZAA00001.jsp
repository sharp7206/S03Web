...
function LoadPage() {
	var Cols = [
        	...
        	{Header : "SysCd", Type:"Text", Width:80,SaveName:"SYS_CD", InsertEdit:1, UpdateEdit:0},
  			...
  			{Header : "Open Y/N", Type:"Combo",Width:60,SaveName:"USE_OPEN_YN",ComboText:"Y|N",ComboCode:"Y|N",PopupText:"Y|N",PopupCode:"Y|N"},
  			{Header : "Use Y/N", Type:"Combo",Width:60,SaveName:"USE_PREVENT_YN",ComboText:"Y|N",ComboCode:"Y|N",PopupText:"Y|N",PopupCode:"Y|N"},
  			{Header : "DB ID", Type:"Text",Width:200,SaveName:"DB_USER_ID"},
  			{Header : "DB PASS", Type:"Text",Width:200,SaveName:"DB_USER_PASSWD"},
  			{Header : "DB Server", Type:"Text",Width:200,SaveName:"DB_SVR_NM"},
  			{Header : "Idle\nTiem", Type:"Text",Width:200,SaveName:"IDLE_TIME"},
  			...
  			{Header : "Sys\nInfo", Type:"Text",Width:200,SaveName:"SYS_INFO"},
...
function doAction(sAction)
{
	switch(sAction)
	{
		...
		case "Add":
			...
			mySheet1.SetCellValue(row, "DISP_ORD", APPz.ui.lpad(rowcnt, 2, "0"));
			break;
	}
}
