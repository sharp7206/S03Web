...
<%@ taglib uri = "http://java.sun.com/jsp/jstl/functions" prefix = "fn" %>
    	<!-- Brand Logo -->
    	<a href="${pageContext.request.contextPath}/main.do" class="brand-link">
    	...
    	<div class="sidebar">
    		<%--
      		...
      		<nav class="m-1">
        		<%--
        		<ul id="menu_root" class="nav nav-pills nav-sidebar flex-column nav-flat nav-compact nav-child-indentn nav-child-indent nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
        		--%>
